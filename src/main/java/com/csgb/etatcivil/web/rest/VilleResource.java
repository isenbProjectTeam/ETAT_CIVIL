...
public class VilleResource {
    ...
    @GetMapping("/villes")
    @Timed
    public ResponseEntity<List<Ville>> getAllVilles(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<Ville>> searchVilles(@RequestParam String query, @ApiParam Pageable pageable) {
